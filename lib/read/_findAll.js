...
var operatorMap = {
  '===' : function (field, value, output) {
    ...
    output.query.multi_match        = output.query.multi_match || {};
    output.query.multi_match[field] = output.query.multi_match[field] || [];
    output.query.multi_match[field].push(value);
  },
